...
For example, both networks suffer a steep drop in accuracy in the Anti task with delay period inactivation (Fig. \ref{fig:SC}F).  
Networks resilient to delay period inactivation had greater $\lambda_{\text{task}}$ and $\lambda_{\text{side}}$ and lower $\lambda_{\text{all}}$ and $\lambda_{\text{diag}}$ (Fig. \ref{fig:SC}E).
