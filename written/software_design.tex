...
\umlclass[x=-1, y=-12]{CouplingArch}{ 
  \# \_type : string \\ 
  \# \_repeats : pos int \\ 
  \# \_num\_couplings : pos int \\ 
  \# \_layers\_per\_coupling : pos int \\ 
  \# \_units\_per\_layer : pos int \\ 
  }
  { 
  + set\_repeats() \\
  + set\_num\_couplings() \\
  + set\_layers\_per\_coupling() \\
  + set\_units\_per\_layer() \\
  + to\_string() \\
  + to\_model() \\
}
...
\umlclass[x=6, y=-12]{AutoregressiveArch}{ 
  \# \_type : string \\ 
  \# \_repeats : pos int \\ 
  \# \_layers\_per\_conditional : pos int \\ 
  \# \_units\_per\_layer : pos int \\ 
  }
  { 
  + set\_repeats() \\
  + set\_layers\_per\_conditional() \\
  + set\_units\_per\_layer() \\
  + to\_string() \\
  + to\_model() \\
}
