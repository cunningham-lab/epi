...
To compare the efficiency of these algorithms for infering RNN connectivity distributions producing stable amplification, we develop a convergence criteria that can be used across methods.
