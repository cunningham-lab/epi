...
We present a novel technique designed to infer parameter distributions that produce mathematically defined emergent properties of computation, rather than sets of experimental data.
We find that conditioning parameter distributions on an emergent property rather than datasets is natural and often advantageous in theoretical practice.
Also, this approach allows us to greatly simplify the deep inference architecture used and to scale inference to high dimensions.
We bring this deep inference technique to bear on important questions in theoretical neuroscience, and demonstrate the broad range of insightful analyses this approach allows.
